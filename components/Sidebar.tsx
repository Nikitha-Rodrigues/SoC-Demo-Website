...
export default function Sidebar(){
  ...
  const flowOptions = [
    ...
    'Fields Modified in Flow'
  ]

  const vulnerabilityOptions = [
    'Vulnerabilities for AttackID',
    'Packets for VulnerabilityID',
    'Flows for VulnerabilityID',
    'Filter Vulnerabilities by Severity',
    'Lookup Vulnerability by ID'
  ]

  const options = section === 'attack' ? attackOptions : section === 'packet' ? packetOptions : section === 'flow' ? flowOptions : vulnerabilityOptions
